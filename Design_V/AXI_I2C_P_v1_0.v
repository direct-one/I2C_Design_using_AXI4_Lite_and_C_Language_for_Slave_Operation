...
module AXI_I2C_P_v1_0 #(
    ...
    AXI_I2C_P_v1_0_S00_AXI #(
        .C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
        .C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
    ) AXI_I2C_P_v1_0_S00_AXI_inst (
        .cmd_start(cmd_start),
        .cmd_write(cmd_write),
        .cmd_read(cmd_read),
        .cmd_stop(cmd_stop),
...
module I2C_Master (
    ...
    assign sda_i = sda;
    assign sda   = sda_o ? 1'bz : 1'b0;  // 3_state_buffer
                        ...
                        case (step)
                            2'd0: begin
                                ...
                                if (is_read) begin
                                    ...
                                    sda_r <= 1'b1;  // sda input defined, generate z(H/Imp)
                                end
                                step <= 2'd1;
                            end
                            2'd1: begin
